  ...
  return (
    <div className="page-card">
      ...
      <div className="banner-section">
        {/* Background SVG Vector Layer (Map + Arcs + Pins + Delivery Truck + Shipping Boxes) */}
        <div className="banner-graphics-layer">
          <svg viewBox="0 0 360 650" fill="none" xmlns="http://www.w3.org/2000/svg" className="banner-svg">
            ...
            {/* Map Pin 3 (Bottom Right above boxes) */}
            ...
            {/* Delivery Truck Outline (Bottom Left) */}
            ...
            {/* Stacked Cargo Shipping Boxes (Bottom Right) */}
        ...
        <div className="banner-logo-wrapper">
          <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Left Tall Pillar with diagonal angle top */}
            <path d="M10 14 L18 6 V38 H10 Z" fill="#6B21A8" />
            {/* Right Shorter Pillar with diagonal angle top */}
